...
const serviceAccount = require(path.join(__dirname, 'systemederecompensesenfantsqa-firebase-adminsdk-fbsvc-2456d05aad.json'));  // Assurez-vous que votre fichier .json est bien à cet endroit
