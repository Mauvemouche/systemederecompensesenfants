...
const fr = {
  ...
  "err.acceptedWithdrawal": "Coche la case sur le droit de rétractation avant de continuer vers le paiement.",
  "err.exportFailed": "Impossible d’exporter les données. Réessaie dans un instant.",
  "err.deleteFailed": "Impossible de supprimer le compte. Réessaie ou écris à contact@kidsrewardsystem.com.",
  "err.deleteConfirm": "Confirme la suppression du compte pour continuer.",
...
const nl = {
  ...
  "err.acceptedWithdrawal": "Vink het vakje over het herroepingsrecht aan voordat je naar de betaling gaat.",
  "err.exportFailed": "De gegevens konden niet worden geëxporteerd. Probeer zo meteen opnieuw.",
  "err.deleteFailed": "Het account kon niet worden verwijderd. Probeer opnieuw of schrijf naar contact@kidsrewardsystem.com.",
  "err.deleteConfirm": "Bevestig de verwijdering van het account om verder te gaan.",
...
const de = {
  ...
  "err.acceptedWithdrawal": "Bitte das Kästchen zum Widerrufsrecht ankreuzen, bevor du zur Zahlung weitergehst.",
  "err.exportFailed": "Die Daten konnten nicht exportiert werden. Versuch es gleich noch einmal.",
  "err.deleteFailed": "Das Konto konnte nicht gelöscht werden. Versuch es erneut oder schreib an contact@kidsrewardsystem.com.",
  "err.deleteConfirm": "Bestätige die Kontolöschung, um fortzufahren.",
...
const en = {
  ...
  "err.acceptedWithdrawal": "Tick the withdrawal-right box before continuing to payment.",
  "err.exportFailed": "Couldn’t export the data. Try again in a moment.",
  "err.deleteFailed": "Couldn’t delete the account. Try again, or write to contact@kidsrewardsystem.com.",
  "err.deleteConfirm": "Confirm account deletion to continue.",
